...
PageAbout::PageAbout(QEmbyCore *core, QWidget *parent) : SettingsPageBase(core, tr("About"), parent)
{
    ...
    auto *forkOwnerLabel = new QLabel(QStringLiteral("Fork maintained by asuhiy"), this);
    ...
    m_linkLabel->setText(QString("<a href=\"https://github.com/asuhiy/ReEmby\">%1</a> &nbsp;|&nbsp; "
                                 "<a href=\"https://github.com/asuhiy/ReEmby/issues\">%2</a>")
